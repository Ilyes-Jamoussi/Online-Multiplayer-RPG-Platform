...
export const TILE_PATH = `${ASSETS_BASE_PATH}/images/tiles`;
export const OBJECT_PATH = `${ASSETS_BASE_PATH}/images/objects`;

export const DICE_PATH = `${ASSETS_BASE_PATH}/images/dice`;
